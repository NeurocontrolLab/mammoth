...
def get_probe_json(map_path, output_path, file_name):
    ...
    for array in array_name:
        ...
        probe_2d.annotate(
            ...
            escription = '128-ch Utah array x 2'
            )
        positions = []
        device_channel = []
...
parser.add_argument('-mp', '--map_path', 
                    default='/AMAX/cuihe_lab/share_rw/CuiLab-Database-All/Archive/Caesar/array_info/11386-000009-M1Array1 PMdArray2.cmp')

parser.add_argument('-o', '--output', type=str, 
                    default='/AMAX/cuihe_lab/share_rw/CuiLab-Database/interception/Caesar/', 
                    metavar='/the/path/you/want/to/save', help='output folder')

args = parser.parse_args()
get_probe_json(args.map_path, args.output, "Caesar_Utah_128x2")
