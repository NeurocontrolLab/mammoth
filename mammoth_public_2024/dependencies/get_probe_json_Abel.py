...
def get_probe_json(map_path, output_path, file_name):
    ...
    for array in array_name:
        ...
        probe_2d.annotate(
            ...
            escription = '64-ch Utah array x 4'
            )
        positions = []
        device_channel = []
...
parser.add_argument('-mp', '--map_path', 
                    default='/AMAX/cuihe_lab/cuilab_share/Abel/Code/sorting_controller/Abel_SN_11386-000096.cmp')

parser.add_argument('-o', '--output', type=str, 
                    default='/AMAX/cuihe_lab/share_rw/Neucyber-NC-2024-A-01/Abel/', 
                    metavar='/the/path/you/want/to/save', help='output folder')

args = parser.parse_args()
get_probe_json(args.map_path, args.output, "Abel_Utah_64x4")
