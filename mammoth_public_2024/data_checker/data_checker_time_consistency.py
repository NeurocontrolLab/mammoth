...
def run(data_dir, output_dir):
    ...
    if neural_event_labels[0]>60000:
        nerual_event_labels = np.array(neural_event_labels)-65280
...
parser.add_argument("-d", "--data", type=str,
                    default='/AMAX/cuihe_lab/share_rw/Neucyber-NC-2024-A-01/Bohr/Data_recording/20240929_interception_001/formatted_data', 
                    metavar='/the/path/your/data/located/in', help='data folder')
parser.add_argument('-o', '--output', type=str, 
                    default='/AMAX/cuihe_lab/share_rw/Neucyber-NC-2024-A-01/Bohr/Data_recording/20240929_interception_001/description', 
