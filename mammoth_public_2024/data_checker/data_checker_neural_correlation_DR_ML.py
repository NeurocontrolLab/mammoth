...
parser.add_argument("-f", "--file", type=str,
                    default='/AMAX/cuihe_lab/share_rw/Neucyber-NC-2023-A-01/Abel/Brain_control/20240810_2dBCSemi120Mannual_001', 
...
plt.savefig(os.path.join(args.output, 'description', 'sliding_R2.png'), dpi=300, bbox_inches = 'tight')
