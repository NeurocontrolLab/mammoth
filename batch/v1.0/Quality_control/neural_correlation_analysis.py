...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug  7 12:11:10 2024
...
#------------------------------------------------------------------------------
# interface for batch processing, -f data folder, -o output folder
#------------------------------------------------------------------------------
...
raw_dirname = args.file # read file name from parsor
...
#%% read pandas data from description
pos_pd = pd.read_csv(os.path.join(description_data_path, 'pos_pd.csv'),header=0,index_col=0)
trial_pd = pd.read_csv(os.path.join(description_data_path, 'trial_pd.csv'),header=0,index_col=0)
coeff_pd = pd.read_csv(os.path.join(description_data_path, 'coeff_pd.csv'),header=0,index_col=0)
frame_pd = pd.read_csv(os.path.join(description_data_path, 'frame_pd.csv'),header=0,index_col=0)
...
with open(os.path.join(args.output, 'description', 'correlation_test_score.txt'), 'w') as file:
    file.write(f'{scores}\n')
