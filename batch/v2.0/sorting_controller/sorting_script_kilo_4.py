...
parser.add_argument('-dp', '--data_path', 
                    default='/home/cuihe_lab/lichenyang/DATA_AMAX/Neucyber-NC-2023-A-01/Bohr/Brain_control/20240306_br_utah_interception_120_semi_brain_control_001')
...
for array in array_name:
    ...
    for ielec in probe_info:
        ...
        positions.append([float(ielec[0])*40, float(ielec[1])*40])
...
sp1 = os.path.join(data_path, 'sorted_data', 'kilosort4_output')
