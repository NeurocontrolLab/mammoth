...
os.chdir('/AMAX/cuihe_lab/cuilab_share/Bohr/Code/sorting_controller')
...
parser.add_argument('-dp', '--data_path', 
                    default='/AMAX/cuihe_lab/share_rw/Neucyber-NC-2023-A-01/Bohr/Brain_control/20240306_BrUtahInterception120SemiBc_002')
