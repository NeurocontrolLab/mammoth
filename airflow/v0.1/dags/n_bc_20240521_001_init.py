...
session = format(r'/AMAX/cuihe_lab/chenyun/test/Nezha/Brain_control/20240521_centerOutKalmanNet_threshold70_001')
...
t2 = BashOperator(task_id='convert_rec_file', 
                  bash_command='''dir='/AMAX/cuihe_lab/chenyun/test/Nezha/Brain_control/20240521_centerOutKalmanNet_threshold70_001/raw_data'
...
t3 = BashOperator(task_id='format_neural_data_no_sort',
                  bash_command='''dir='/AMAX/cuihe_lab/chenyun/test/Nezha/Brain_control/20240521_centerOutKalmanNet_threshold70_001'                                                   
echo $dir
